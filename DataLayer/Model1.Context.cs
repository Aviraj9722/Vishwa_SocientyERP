...
namespace DataLayer
{
    ...
    public partial class Society_Entities : DbContext
    {
        public Society_Entities()
            : base("name=Society_Entities")
        {
        }
        ...
        public virtual DbSet<tblSecretary> tblSecretaries { get; set; }
        public virtual DbSet<tblSocietyMaster> tblSocietyMasters { get; set; }
